...
impl ScriptVariant {
    ...
    pub fn to_script(&self) -> Script {
        match self {
            ...
            ScriptVariant::P2PK(PubKeyVariant::Compressed(pk)) => Script::p2pk(pk),
            ScriptVariant::P2PK(PubKeyVariant::Uncompressed(pk)) => Script::p2pk_uncompressed(pk),
...
mod tests {
    ...
    fn test_script_variant() -> Result<(), ScriptTypeError> {
        assert_eq!(
            ScriptVariant::from_type_and_payload(ScriptType::P2PKH, &[2; 33]).unwrap_err(),
        ...
        assert_eq!(
            ScriptVariant::from_type_and_payload(ScriptType::P2SH, &[2; 33]).unwrap_err(),
            DataError::InvalidLength {
                expected: 20,
                actual: 33,
            },
        ...
        assert_eq!(
            ScriptVariant::from_type_and_payload(ScriptType::P2PK, &[2; 20]).unwrap_err(),
        ...
        assert_eq!(
            ScriptVariant::from_type_and_payload(ScriptType::P2PK, &[4; 64]).unwrap_err(),
            DataError::InvalidLengthMulti {
                expected: vec![33, 65],
                actual: 64,
            },
